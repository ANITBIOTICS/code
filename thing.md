...
:root {
    ...
    --text-2: hsl(220, 100%, 84%); /* headings and important text */
    --text-3: hsl(221, 100%, 91%); /* normal text */
    --text-4: hsl(220, 91%, 87%); /* icon buttons and channels */
    --text-5: hsl(219, 22%, 58%); /* muted channels/chats and timestamps */
    ...
    --bg-4: rgb(16, 22, 36); /* main background color */
    --hover: hsla(220, 32%, 22%, 0.527); /* channels and buttons when hovered */
    ...
    --message-hover: rgba(45, 43, 71, 0.902); /* messages when hovered */
    ...
    --online: var(--green-3); /* change to #40a258 for default */
    ...
    --offline: var(--text-2); /* change to #82838b for default offline color */
    ...
    --blue-1: oklch(80% 0.4 265);
    --blue-2: oklch(70% 0.1 265);
    --blue-3: oklch(65% 0.1 265);
    --blue-4: oklch(60% 0.1 265);
    --blue-5: oklch(55% 0.1 265);
